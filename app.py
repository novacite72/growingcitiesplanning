    ...
    return {
        ...
        "sections": [
            {"h": "1. 출장개요", "body":
             ...
             "<p class='l2'>2) 출장지</p>"
             "<p class='l3'>○ 핀란드 헬싱키·에스포 (WPSC 2026 개최지)</p>"
             "<p class='l2'>3) 출장기간</p>"
             ...
             "<tr><td>6/28(일)</td><td>헬싱키 도착</td><td>05:30 헬싱키 반타공항 도착 · 숙소(중앙역) 체크인 · 도심 적응</td></tr>"
             "<tr><td>6/29(월)</td><td>에스포·헬싱키 / 알토대</td><td>도시계획 현장조사(타피올라·야트카사리) · WPSC 등록·개막식·기조강연 · 에스포시 리셉션</td></tr>"
             "<tr><td>6/30(화)</td><td>에스포 / 알토대</td><td>기조강연·병렬세션 · ★논문 구두발표(16:00, Track 1)</td></tr>"
             "<tr><td>7/1(수)</td><td>헬싱키 / 헬싱키대</td><td>기조강연·모바일 워크숍·VR 워크숍</td></tr>"
             "<tr><td>7/2(목)</td><td>에스포 / 알토대</td><td>병렬세션 · GPEAN 협력 컨택 · 작별 리셉션(시청)</td></tr>"
             "<tr><td>7/3(금)</td><td>에스포 / 알토대</td><td>세션·라운드테이블 · 생활권 지원모듈 협력방안 논의 · 폐회식</td></tr>"
             "<tr><td>7/4(토)~7/5(일)</td><td>헬싱키 → 인천</td><td>이동 (핀에어 AY41)</td></tr></table>"},
            {"h": "2. 출장내용", "body":
             "<p class='l2'>1) 6월 28일(일) — 헬싱키 도착</p>"
             "<p class='l4'>○ 6/27(토) 인천 출발, 익일 05:30 헬싱키 반타공항 도착 · 숙소(중앙역 인접) 체크인 및 학회 참가 준비</p>"
             "<p class='l2'>2) 6월 29일(월) — 도시계획 현장조사 · WPSC 개막</p>"
             ...
             "<p class='l3'>(3) WPSC 개막식 (알토대 오타니에미)</p>"
             "<p class='l4'>○ 개막식 및 개막 기조강연(Anacláudia Rossbach, UN-Habitat 사무총장) 참석, 에스포시 주관 환영 리셉션 네트워킹</p>"
             "<p class='l3'>(4) 연구과제 적용방안</p>"
             ...
             "<p class='l4'>○ 헬싱키대 환영사·기조강연 참석, 학회 주관 모바일 워크숍(MW13 — 녹색전환 광역계획, 헬싱키 도시계획 현장 탐방) 참가, UrbanISE VR 워크숍(본관 3층 Studium 1) 참관</p>"
             ...
             "<p class='l2'>6) 7월 3일(금) — 알토대 세션 · 협력 마무리</p>"
             "<p class='l4'>○ 알토대 세션·라운드테이블 참석, 생활권 계획 지원모듈 관련 GPEAN 협력방안 후속 논의 및 폐회식 참석</p>"},
            {"h": "3. 주요 성과", "body":
    ...
    while i < n:
        ...
        if '|' in s and i + 1 < n and _re.match(r'^\s*\|?[\s:|-]*-[\s:|-]*\|?\s*$', lines[i + 1]):
            ...
            while i < n and '|' in lines[i] and lines[i].strip():
                ...
                cells = (cells + [''] * ncol)[:ncol]   # 헤더 열 수에 맞춰 보정(표 깨짐 방지)
...
WC_DISCUSSIONS = [
    ...
    {'slug': 'disc-2026-kpa-ai-personas-choijunyoung', 'kind': 'discussion',
     'discType': '토론 발언 · 두 페르소나',
     'title': '[토론 발언] 두 페르소나의 시선 — 도시AI 연구자와 스마트도시계획가 (최준영)',
     'event': '2026 국토교통기술대전 학술세미나 「AI와 도시계획·설계의 미래: 기회와 도전」',
     'session': '종합토론', 'date': '2026-06-25', 'venue': '코엑스 컨퍼런스룸 E4 (3F)',
     'host': '대한국토·도시계획학회 4차산업혁명위원회 · KAIA',
     'discussant': '최준영', 'affiliation': '서울연구원 글로벌연구협력센터장',
     'moderator': '최창규 (한양대학교 교수, 학회 학술부회장)',
     'summary': '최준영을 두 자아 — (A) 도시AI 연구자, (B) 스마트도시계획가 — 로 나눠 두 발표를 토론용 구어체로 풀어낸 발언문. r5r·OSRM·networkx 기본값과 재현성, MAI의 가정, model collapse, ILP 가로배분, 몬테카를로 불확실성 같은 기술적 견해와, AI 의존에 따른 역량 마모(deskilling)의 1인칭 고백을 함께 담았다.',
     'tags': ['토론 발언', '페르소나', '도시AI', '스마트도시계획', 'r5r·OSRM', 'model collapse', 'deskilling', '기술적 토론', '민감도 분석', 'ILP'],
     'relatedPresentations': ['disc-2026-kpa-ai-pres1-kimseungnam', 'disc-2026-kpa-ai-pres2-eomsunyong', 'disc-2026-kpa-ai-panel-choijunyoung'],
     'body': '## 두 페르소나 한눈에 — 한줄평·특징·비교\n### (A) 도시AI 연구자\n**한줄평 —** “도구의 한계가 사라지자, 한계는 질문의 깊이로 옮겨갔다.”\n- OSM·networkx·OSRM·r5r로 접근성 알고리즘을 직접 짜온 방법론 개발자\n- 과거 고난도 문제는 외부에 의존 → 지금은 Claude Code·Codex로 전부 직접 구현\n- 머릿속 구상만 하던 진보된 연구(동적 GTFS, 강화학습 재배치, 멀티모달)까지 실현\n- 강점: 구상에서 구현까지의 사이클이 폭발적으로 단축, 학제 확장\n- 그림자: ‘외부 의존’이 ‘AI 의존’으로 옮겨졌을 뿐 — 검증·기본값·소유권 책임은 전부 본인 몫\n- 태도: 낙관적 증강(augment), 생산성 신봉\n### (B) 스마트도시계획가\n**한줄평 —** “판단만 남았다고 믿었는데, 그 판단마저 어느새 위탁하고 있었다.”\n- 거시·미시 도시변화 담론 위에 선 계획가·의사결정자\n- 빅데이터뿐 아니라 조사원의 현장 1차 데이터(관찰·설문)를 중시\n- 현장조사 분석을 넘어 의사결정에도 AI를 활용\n- 강점: 현장 직관 + 데이터, 거버넌스·의사결정 경험\n- 그림자: 판단의 외주화·역량 마모(deskilling)를 1인칭으로 자각\n- 태도: 성찰적 경계(reflective caution), 책임·진정성 중시\n### 비교 — 같은 사람의 두 자아\n- **무엇을 보는가**: (A) 도구로서의 AI, 분석을 ‘만든다’ ↔ (B) 대상으로서의 AI, 도시를 ‘바꾸고’ 판단을 ‘위탁한다’\n- **핵심 동력**: (A) 가능성·생산성 ↔ (B) 책임·진정성\n- **AI와의 관계**: (A) 증강(augment) ↔ (B) 의존의 자각(대체 위험)\n- **다루는 데이터**: (A) 코드·알고리즘·기본값 ↔ (B) 현장·조사원·맥락\n- **시간 지향**: (A) “이제 못 만들 게 없다”(미래) ↔ (B) “예전엔 직접 했는데”(상실)\n- **위험 인식**: (A) 검증·소유권을 내가 떠안음 ↔ (B) 판단 근육이 빠진다\n- **한 문장**: (A) “한계는 질문의 깊이다” ↔ (B) “직접 할 줄 아는 능력을 어디까지 지킬까”\n- **종합**: 둘은 대립이 아니라 한 사람 안의 긴장이다 — A의 ‘할 수 있다’와 B의 ‘잃고 있다’가 부딪히는 자리에서 이 토론이 태어난다.\n\n## 시작하며 — 둘로 갈라진 토론자\n두 분 발표 잘 들었습니다. 토론을 준비하면서 제가 둘로 갈라져 있다는 걸 깨달았습니다. 한쪽은 데이터로 도시를 분석하는 ‘연구자로서의 저’, 다른 한쪽은 현장과 의사결정에 선 ‘계획가로서의 저’입니다. 오늘은 이 두 사람을 번갈아 등장시켜 말씀드리겠습니다. 공교롭게도 이 두 자아의 대화가, 엄 교수님이 소개하신 ‘시민 페르소나’ 이야기와 묘하게 겹칩니다.\n### 두 개의 저\n- **(A) 도시AI 연구자** — 예전엔 OSM에 networkx·OSRM·r5r를 얹어 접근성 알고리즘을 짰고, 어려운 문제는 외부에 맡겼습니다. 지금은 Claude Code·Codex로 그 알고리즘을 제 손으로 다 만들고, 머릿속에만 있던 연구까지 직접 합니다.\n- **(B) 스마트도시계획가** — 거시·미시 도시변화를 보면서 빅데이터뿐 아니라 조사원을 현장에 보내 데이터를 모아 분석해 왔습니다. 지금은 분석을 넘어 의사결정에도 AI를 씁니다. ‘결국 사람의 판단만 남는다’고 믿어왔는데, 어느 순간 예전엔 직접 하던 일까지 AI에 맡기고 있더군요.\n\n## 연구자로서 — 엄선용 교수님께\n엄 교수님, “논문 한 편하고 정제도 안 된 원본데이터만 넣으면 재현된다”는 대목에서 무릎을 쳤습니다. 제가 r5r로 멀티모달 접근성을 돌리려면 예전엔 JVM 메모리 설정부터 GTFS의 service_id 처리, OSM 도로위계 필터까지 전문가 손을 빌렸거든요. 지금은 Codex가 초안을 뚝딱 냅니다. 그런데 바로 그래서 세 가지를 짚고 싶습니다.\n첫째, 기본값이 결론을 만듭니다. R5의 max_walk_time, 출발시간 윈도, 보행속도 3.6km/h, OSRM의 도로별 기본 속도 — 이 숫자 하나만 바꿔도 접근성 지도가 달라집니다. 그래서 저는 AI에게 분석을 시킬 때 반드시 민감도 분석을 같이 만들게 합니다.\n둘째, 돌아간다고 맞는 게 아닙니다. AI가 짠 코드는 좌표계가 어긋나거나, GTFS 운행계획을 잘못 읽거나, 격자를 도로망에 잘못 붙여도 ‘그럴듯하게’ 결과를 내놓습니다. 골든 데이터셋과 단위테스트로 거르지 않으면 저도 속습니다.\n셋째, MAI, 다중활동 접근성은 기술적으로 정말 흥미롭습니다. 다만 어느 지점을 ‘활동 거점’으로 잡고 시간예산을 몇 분으로 두느냐가 결과를 정합니다. 결국 방법이 아니라 ‘가정’이 정책을 만드는 셈이죠.\n그리고 합성 페르소나, Nemotron 말씀. 저도 LLM으로 시민의견을 흉내 내봤습니다. 솔직히 실제 조사로 보정(calibration)하지 않으면 그건 그럴듯한 환각이었습니다. 작년 Nature에는 합성데이터로 재귀학습하면 모델이 붕괴한다는(model collapse) 보고도 있었죠. 합성이 합성을 먹고 자라면 시민과는 점점 멀어집니다.\n\n## 계획가로서 — 엄선용 교수님께\n이번엔 계획가로서 말씀드립니다. 교수님은 “검증 책임이 오히려 커진다”고 하셨죠. 맞습니다. 그런데 제 현장에서는 그 말이 거꾸로 ‘검증할 능력이 줄어든다’로 나타나고 있어 두렵습니다. 의사결정에 AI를 들이면서, 예전엔 제 손으로 따지던 걸 어느새 AI에 맡기고 있거든요. 책임은 커졌는데 그걸 감당할 근육은 빠지는 겁니다.\n또 하나, 저는 조사원을 현장에 보내 데이터를 모아온 사람입니다. 거리이미지나 통신 데이터가 아무리 많아도, 사람이 왜 그렇게 움직이는지 그 ‘왜’는 현장에서만 잡힙니다. 멀티모달 LLM 가로경관 평가, 반복하면 신뢰도 0.9 나옵니다. 하지만 신뢰도가 높다는 것과 맞다는 것은 다릅니다. 사람 코더끼리도 같은 장면을 다르게 읽는 일을 숱하게 봤습니다.\n\n## 연구자로서 — 김승남 교수님께\n김 교수님, “AI가 도시를 집중시킬지 분산시킬지 그 방향은 못 맞춰도, 영향을 받을 공간의 범주는 안다”는 진단은 방법론적으로 정확합니다. 저라면 이걸 코드로 옮기겠습니다. 행위자기반모형이나 디지털트윈으로 시나리오를 여러 개 돌리는 거죠. 다만 결과가 자율주행 보급률 같은 ‘가정’에 휘둘리니, 단일 예측 대신 몬테카를로로 불확실성을 함께 보여줘야 합니다. ‘Law가 아니라 Lane’이라는 말씀, 기술자 입장에서도 동의합니다.\n가로공간 재배분도 사실 최적화 문제입니다. 도로변 용도를 시간대별로 배분하는 ILP로 풀 수 있어요. 그리고 분절적 도시화, splintering urbanism — 제가 그 격차의 양쪽을 다 살아봤습니다. 외부에 의존하던 시절엔 늘 뒤처졌고, AI를 손에 쥔 지금은 역량이 폭발했습니다. 그래서 압니다. AI를 못 쥔 도시와 연구실은 구조적으로 밀려납니다. 그 경고가 피부로 옳습니다.\n\n## 계획가로서 — 김승남 교수님께\n계획가로서 보면, 교수님이 말씀하신 미시적 공간 경쟁 — 배송로봇이 보도를 차지하고 옥상을 두고 다투는 일은 데이터보다 현장에서 먼저 보입니다. 로봇 진입구를 어디 둘지 같은 설계 표준은 현장 관찰에서 나와야 합니다. 데이터센터 입지와 수용성도 제가 실제로 마주하는 의사결정 현안이고요.\n그런데 부끄러운 고백을 하나 하겠습니다. 저는 AI 추천이 사람들을 같은 장소로만 몰아 도시를 획일하게 만드는 걸 걱정합니다. 그러면서 정작 제 의사결정엔 AI를 쓰고 있습니다. ‘열린 설계’를 말하는 제 머릿속은 점점 닫히고 있는지도 모릅니다.\n\n## 마치며\n정리하겠습니다. 연구자로서의 저는 “이제 한계는 도구가 아니라 질문의 깊이”라고 말합니다. 계획가로서의 저는 “그 질문을 던질 능력과 답을 의심할 근육이 마모되고 있다”고 답합니다. 두 분 발표가 만난 그 지점에 답이 있다고 봅니다 — **AI는 우리를 대체하지 않지만, 우리가 스스로를 대체하도록 내버려 둘 수는 있습니다.**\n그래서 제안은 두 갈래입니다. 기술 쪽으로는 민감도 분석·골든 데이터셋·실측 보정·알고리즘 등록부로 연구자의 생산성을 떠받치자는 것, 사람 쪽으로는 ‘먼저 직접, 그다음 AI’ 원칙과 검증 역량의 자격화, 그리고 의도적인 마찰을 남기자는 것입니다.\n마지막으로 좌중에 질문 하나 던지겠습니다. 합성 페르소나의 위험을 토론하는 저 자신이 오늘 두 개의 페르소나로 갈라져 이 자리에 섰습니다. 우리는 계획가로서 ‘직접 할 줄 아는 능력’을 어디까지 지켜야 할까요? 감사합니다.'},

    {'slug': 'disc-2026-kpa-ai-persona-vs-human', 'kind': 'discussion',
     'discType': '메타 분석 · 페르소나 vs 휴먼',
     'title': '[분석] AI 페르소나 vs 실제(휴먼) 토론 — 최준영',
     'event': '2026 국토교통기술대전 학술세미나 「AI와 도시계획·설계의 미래: 기회와 도전」',
     'session': '메타 분석', 'date': '2026-06-25', 'venue': '코엑스 컨퍼런스룸 E4 (3F)',
     'host': '대한국토·도시계획학회 4차산업혁명위원회 · KAIA',
     'discussant': '최준영', 'affiliation': '서울연구원 글로벌연구협력센터장',
     'summary': 'AI가 그의 이력·방법론으로 생성한 ‘두 페르소나’ 토론 발언과, 최준영이 실제로 녹음한 토론 준비 발언(휴먼)을 비교 분석. 페르소나는 데이터 소유권·deskilling·블랙박스·검증 책임 등을 놀랍게 예측했지만, 의제의 기원·즉흥적 자기발견(‘AI는 내가 설계한 틀 안에서만 답한다’)·자조의 진정성은 끝내 만들지 못했다.',
     'tags': ['메타 분석', '페르소나', '휴먼', 'deskilling', '데이터 소유권', '검증 책임', '인식론적 종속', 'AI의 한계'],
     'relatedPresentations': ['disc-2026-kpa-ai-personas-choijunyoung', 'disc-2026-kpa-ai-pres1-kimseungnam', 'disc-2026-kpa-ai-pres2-eomsunyong'],
     'body': '## 무엇을 비교했나\n같은 종합토론을 두 버전으로 놓고 비교한다 — **(A)** AI가 그의 접근성 연구 이력·방법론을 바탕으로 생성한 ‘두 페르소나’ 발언([[disc-2026-kpa-ai-personas-choijunyoung]]), **(B)** 최준영이 실제로 녹음한 토론 준비 발언(휴먼). 둘은 많은 핵심에서 겹치지만, 결정적인 곳에서 갈린다.\n\n## 놀랍게 일치한 지점 — 페르소나가 ‘예측’한 것\n충분한 맥락(접근성 연구 이력)으로 만든 페르소나는 실제 발언의 상당 부분을 맞혔다.\n- **데이터 소유권**: 페르소나가 짚은 ‘GTFS·OSM의 소유권’을 실제로도 그대로 — “GTFS나 OSM이나 내가 아니라 민간이 하는 거고… 내가 오너십을 가지고 있는 건 아니에요.”\n- **deskilling(networkx·OSRM)**: 페르소나의 ‘예전엔 내부까지 직접’이, 실제로는 자조로 — “예전에는 networkx까지 고민했잖아. OSRM 구성하는 고민도 이제 안 하잖아.”\n- **블랙박스**: 페르소나의 ‘재현 ≠ 이해’가 — “내가 안다면 위험성을 알겠지만, 모른다면 그냥 블랙박스야.”\n- **누구나 가능 → 전문가의 역할**: “이제는 누구나 할 수 있어요. 그러니까 전문가가 어떤 게 필요한지를 봐야 되는 거죠.”\n- **검증 책임**: “기술 허들은 낮아졌지만 그 책임성을 누가 판단하고 누가 할 것이냐.”\n- **X-minute city를 직접 돌려본 경험**: “예전에는 직접 돌려봤단 말이에요. 저도 다 돌려봤잖아요. 근데 지금은 안 하잖아.”\n\n## 실제 토론만이 가진 것 — 페르소나가 놓친 것\n1. **의제의 기원(authorship)**: 그는 단순 토론자가 아니다 — “이거 2022/2023년에 제가 김승남 교수한테 처음 맡겼던 주제예요: ‘AI 시대의 계획가는 살아남을 수 있는가’.” 페르소나엔 이 ‘출제자’ 정체성이 없다.\n2. **‘8년 전부터 한 얘기’ — 새로운 건 내용이 아니라 실행비용의 붕괴**: “공간 재편은 8년 전에도 한 교과서적 얘기. 달라진 건, 전엔 전문적이고 비쌌던 실험이 지금은 쉬워졌다는 것(특히 컴퓨터비전 허들).”\n3. **김승남 발표에 대한 더 날카로운 비판**: “질문은 던졌는데 결론(답)이 없어요.” 페르소나는 김승남에게 대체로 동의·확장만 했지만, 실제는 ‘결론 부재’를 정면으로 지적했다.\n4. **가장 독창적인 통찰 — ‘AI는 내가 설계한 틀 안에서만 답한다’**: “클로드에 시키면 내가 생각한 틀로 결론을 내줘요. 근데 내가 다른 방향의 검증을 설계 안 하면, 얘가 만들어준 데서만 나오는 거예요. 그러면 나아지지도 않는 거죠.” deskilling을 넘어선 **인식론적 종속(epistemic lock-in)**의 통찰로, 페르소나엔 없다.\n5. **현장 디테일과 즉흥성**: S2Vec, BigValue, 좌표계, 컴퓨터비전 허들처럼 슬라이드를 훑으며 튀어나오는 고유명사·자조. 페르소나는 더 정제됐지만 덜 생생하다.\n\n## 스타일·형식의 차이\n- **페르소나(AI)**: 정제된 섹션·번호, ‘두 자아의 변증법’으로 균형 있게 종합한 완결된 학회용 발언문.\n- **휴먼**: 비선형 스트림오브컨시어스, 반복·생략·구어, 미완결(“5분만, 뒤에 하나 더 있어요”), 슬라이드를 보며 하나의 결론(프레임 종속성·검증 책임)으로 점차 수렴.\n\n## 메타 결론 — 페르소나의 한계가 곧 그의 결론이다\n페르소나(AI)는 **‘알려진 것의 합성’**엔 강했다. 그의 이력·방법론이라는 틀을 주자 데이터 소유권·deskilling·블랙박스·검증 책임을 정확히 재현했다. 그러나 끝내 만들지 못한 것은 (1) 그 의제를 처음 낸 **기원**, (2) 그 자리에서 새로 **발견한 통찰**(‘AI는 내 틀을 벗어나지 못한다’), (3) 즉흥과 자조의 **진정성**이었다.\n바로 이 한계가, 실제 최준영이 엄선용 토론에서 도달한 결론의 살아있는 증거다 — **AI는 내가 설계한 틀 안에서만 답한다.** 페르소나는 ‘내가 준 틀(이력)’ 안에서만 그를 재현했고, 그가 현장에서 새로 길어 올린 생각은 만들어내지 못했다. 합성 페르소나가 실제를 대체할 수 없는 이유가, 그 페르소나 자신에 의해 입증된 셈이다.'},
]

# 통합 문서 — 두 발표 요약+토론(낙관 비판·심화·사례)을 하나의 웹 문서로 합성.
# 개별 발표 레코드의 body를 그대로 재사용하므로 내용이 분기되지 않는다(단일 출처).
def _build_combined_discussion():
    by = {d['slug']: d for d in WC_DISCUSSIONS}
    p1 = by['disc-2026-kpa-ai-pres1-kimseungnam']
    p2 = by['disc-2026-kpa-ai-pres2-eomsunyong']
    body = (
        '# 2개 발표 요약·토론 통합 자료\n'
        '2026 국토교통기술대전 학술세미나 「AI와 도시계획·설계의 미래: 기회와 도전」(2026.6.25, 코엑스 컨퍼런스룸 E4)의 '
        '두 주제발표 요약과 토론(낙관 비판·심화·핵심 사례)을 하나의 문서로 통합한 자료다.\n\n'
        '**공통 결론 —** AI는 계획가를 대체하지 않으며, 공공적 판단·검증의 책임은 오히려 커진다. '
        '김승남(대상으로서의 AI = 공간을 바꾸는 힘)과 엄선용(도구로서의 AI = 분석을 돕는 도구)은 상호 보완적이다.\n\n'
        '# Ⅰ. 발표 1 — 김승남(중앙대): AI 시대의 도시공간 변화 예측과 대응\n\n'
        + p1['body'] +
        '\n\n# Ⅱ. 발표 2 — 엄선용(한양대): 빅데이터 분석을 위한 AI의 활용 방안\n\n'
        + p2['body']
    )
    return {
        'slug': 'disc-2026-kpa-ai-combined', 'kind': 'discussion',
        'discType': '통합 자료(요약+토론)',
        'title': '[통합 문서] 2개 발표 요약·토론 — AI와 도시계획·설계의 미래',
        'event': '2026 국토교통기술대전 학술세미나 「AI와 도시계획·설계의 미래: 기회와 도전」',
        'session': '발표·토론 통합', 'date': '2026-06-25', 'venue': '코엑스 컨퍼런스룸 E4 (3F)',
        'host': '대한국토·도시계획학회 4차산업혁명위원회 · KAIA',
        'summary': '두 주제발표(김승남·엄선용)의 요약과 토론(낙관에 가려진 것들·심화·합성 페르소나·과잉 의존·핵심 사례)을 하나의 웹 문서로 통합한 자료. 세미나 전체를 한 페이지에서 통독할 수 있다.',
        'tags': ['통합 자료', '발표 요약', '토론', 'AI 도시계획', 'AI urbanism', '도시 빅데이터', '도시계획학회'],
        'relatedPresentations': ['disc-2026-kpa-ai-pres1-kimseungnam', 'disc-2026-kpa-ai-pres2-eomsunyong', 'disc-2026-kpa-ai-panel-choijunyoung'],
        'body': body,
    }

WC_DISCUSSIONS.insert(0, _build_combined_discussion())
