...
const CHANGELOG=[
  ...
  {v:'v0.40', date:'2026-06-17', items:[
    '글로벌 도시 연구(worldcities)에 <b>📄 글로벌 연구 디렉토리</b> 신설 — 국제기구 서울유치 연구의 두 보고서(CABEI 한국사무소 보고서, 인터뷰 조사 중간보고서)를 디렉토리 하위 문서로 추가. 상세에서 “전문 보기”로 전체 보고서를 엽니다.',
  ]},
  {v:'v0.39', date:'2026-06-17', items:[
    '🏛 국제기구(UIA) 디렉터리에 <b>설립연도·국가·도시 필터</b>와 정렬·페이지네이션 추가. 약 8만 개 기관을 전용 인덱스 테이블로 옮겨 국가 선택·도시 입력·설립연도 범위·이름 검색을 조합해도 <b>지연 없이</b> 즉시 로딩됩니다.',
  ]},
  {v:'v0.38', date:'2026-06-15', items:[
    '🏛 국제기구(UIA) 디렉터리를 <b>전체 약 8만 개 기관</b>으로 확장 — UIA 국제기구 연감(Yearbook) 3,199페이지 전량을 수집·저장하고, 기관명·약어·도시·국가로 빠르게 검색할 수 있습니다.',
  ]},
  {v:'v0.37', date:'2026-06-15', items:[
    '세계대도시협력에 <b>🏛 국제기구(UIA) 디렉터리</b> 탭 추가 — UIA 국제기구 연감에서 도시·도시협력 관련 기관을 별도 저장하고, 기관명·약어·도시·국가로 검색할 수 있습니다.',
  ]},
  {v:'v0.36', date:'2026-06-15', items:[
    'WPSC 출장 일정 — 프로그램을 <b>트랙·발표장(room)별</b>로도 검색하도록 필터 추가. 세계대도시협력 게시판 — 각 협력사항 세부 내용을 <b>불릿 포인트</b>로 표시, 협력자료 분석에서 <b>국외출장·연구원내원·글로벌협력기관 분류 선택</b> 추가, <b>수퍼관리자</b>는 각 항목을 직접 <b>추가·편집·삭제</b>(DB 저장).',
  ]},
  {v:'v0.35', date:'2026-06-15', items:[
    'WPSC 출장 일정 — 공식 상세 프로그램을 발표장소(room)까지 포함해 갱신(1,563건). 프로그램 탭의 각 발표에 🏛 발표장·세션명 표기, 화·목·금=Aalto 오타니에미/수=헬싱키대 도심 안내, 기조·전체세션 발표장 목록 추가. 내 발표(ID 1385) = Track 1, 화 16:00–17:30, U413(Aalto).',
  ]},
  {v:'v0.34', date:'2026-06-15', items:[
    '세계대도시협력(WPSC) 게시판 정비 — 국외출장·연구원 내원을 연도별로 구분 표시하고, WUF13 MeTTA 세션을 글로벌 협력기관(MeTTA 사무국)으로, 태국 중앙공무원위원회·파리지역연구원 교류를 연구원 내원으로 재분류. 출장 일정 페이지에 도로망 기반 동선 지도·「가볼 곳·먹거리」·헬싱키 시청 리셉션·최신 뉴스레터 반영. 전체 구조도(아키텍처)·시스템 매뉴얼 갱신.',
  ]},
  ...
  {v:'v0.30', date:'2026-06-14', items:[
    ...
    '서브시스템 명칭 변경 — “세계도시 연구 DB” → “Global Urban Research · 글로벌 도시 연구”(섹션 제목·카드·전 페이지 라벨)',
  ]},
  {v:'v0.29', date:'2026-06-14', items:[
    'WPSC 출장 일정 페이지(/wpsc/itinerary) 상단에 플랫폼 네비게이션 추가 — 로그인 사용자는 서브시스템 이동 스위처, 비로그인 공개 사용자는 “플랫폼 홈” 링크만 표시',
  ]},
  {v:'v0.28', date:'2026-06-14', items:[
    '지식 그래프(/graph)에서 도시연구·로봇연구 그래프를 분리 — “🕸 통합 / 🌐 도시연구 / 🤖 로봇연구” 보기 전환',
    '세계대도시협력(WPSC)에 “📂 협력자료 분석” 추가 — 파일·폴더를 끌어다 놓으면 브라우저 안에서 분석(서버 전송 없음), 협력 네트워크 매칭·국가·키워드 요약을 웹에 표시',
  ]},
  ...
  {v:'v0.25', date:'2026-06-14', items:[
    ...
    '한-캐나다 서울–토론토 자율주행 배송로봇(ADR) 공동연구를 참고문헌과 함께 도시로봇 DB에 발행(AHP 5기준·22지표 포함)',
  ]},
  ...
  {v:'v0.23', date:'2026-06-14', items:[
    ...
    '도시로봇·HRI DB: 로봇유형·사례·HRI 구성개념·연구설계·관찰/실험 프로토콜·연구도구·정책이슈',
    '연구 산출물 생성기 3종(HRI 연구설계·관찰 코딩북·실험 프로토콜)과 Markdown 내보내기',
    '두 DB는 슬러그 기반으로 상호 교차연결(예: 서울 ↔ 자율주행 배송로봇 사례)',
  ]},
